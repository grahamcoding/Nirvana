    ...
    return (
        <Fade in>
         <div className="container py-5">
          ...
          <iframe className='img-fluid' src="https://www.google.com/maps/embed?origin=mfe&pb=!1m3!2m1!1s700+Cedar+Street+Alexandria+MN!6i15" width="400" height="400" frameborder="1" style={{border:0}} allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
            </div>
